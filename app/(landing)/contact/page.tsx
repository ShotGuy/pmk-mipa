            ...
            <div className="container mx-auto px-6 max-w-6xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-12 items-start">
                    ...
                    <div className="space-y-8">
                        <div className="bg-white dark:bg-[#25211f] p-8 border-4 border-foreground retro-shadow space-y-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start gap-6">
                                    ...
                                    <div className="space-y-1 mt-1">
                                        ...
                                        <p className="text-sm font-serif font-bold text-foreground/80 tracking-wide">pmkmipafstundana@gmail.com</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-6">
                                    ...
                                    <div className="space-y-1 mt-1">
                                        ...
                                        <p className="text-sm font-serif font-bold text-foreground/80 tracking-wide">+62 815 5842 3379 (Kak Lily)</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Google Maps Embed */}
                        <div className="h-[400px] bg-white dark:bg-[#25211f] border-4 border-foreground retro-shadow p-2">
                            <iframe
